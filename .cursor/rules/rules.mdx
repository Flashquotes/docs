...
- Be concise and to the point! Spartan and laconic is our writing style.
...
<Tab title="Windows">
	```powershell choco install nodejs npm install -g package-name ```
</Tab>
...
<Frame>
	<img
		src="/images/leads/lead-dashboard.png"
		alt="Main dashboard showing analytics overview"
	/>
</Frame>

<Frame caption="The analytics dashboard provides real-time insights">
	<img src="/images/changelog/email-analytics.webp" alt="Analytics dashboard with charts" />
</Frame>
