...
- From the booking's invoice editor
...
<Note>
  Automated emails — workflow steps and [invoice reminders](/invoices/reminders) — address the booking's current contact at the moment they send, so nothing keeps going to the old contact after the change.
</Note>
