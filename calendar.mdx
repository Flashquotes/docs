...
<Info>
Blocked dates are full-day only and always make the date unavailable to customers. You can't block part of a day, and there's no internal-note or personal-event option that keeps the date bookable. For team reminders like PTO, add an internal note on an event or quote instead.
</Info>
