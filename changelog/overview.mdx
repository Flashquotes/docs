...
The customer-facing booking form now requires a complete, dispatchable event address before customers can advance past that step. **Next** won't advance and an inline message appears until the address is complete.
