...
Admins can now reorder quote line items with simple drag and drop functionality. Quickly reorganize services, add-ons, and custom items to present your quotes in the most logical order for your clients. This helps create better flow and improves quote readability, especially for complex multi-service events.

**Key Features:**
- **Intuitive Drag & Drop**: Click and drag any line item to reposition it
- **Admin-Only Access**: Only admin users can reorder items for quality control
- **Real-Time Updates**: Changes save automatically as you drag
- **Visual Feedback**: Clear visual indicators show where items will be placed

Perfect for organizing complex quotes where presentation order matters - like grouping related services together or placing your signature offerings first.
