...
- **Mid-form button** — defaults to **"Get Custom Pricing"** (or **"Build My Quote"** when Instant Quoting is on)
- **Last-page button** — defaults to **"Get My Quote"** (or **"Build My Quote"** when Instant Quoting is on)

Hover the button in the live preview, click to edit, then press **Enter** or click outside to save. Leave it blank and it falls back to the platform default. Labels are capped at 100 characters.
