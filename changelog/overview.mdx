...
Set per-service staffing rules that automatically calculate staff and resource quantities on quotes. Choose from four modes — Simple, Guest Count, Duration Only, or Staff Duration Matrix — based on how your staffing scales.

[Learn more about the Staff & Resource Calculator →](/services/staff-resource-calculator)
