...
<Update label="Week of June 22, 2026">

A quick recap of what shipped this week — focused on giving your lead intake form a sharper, more organized first impression.

### New features

- **Group Services into Sections** — Organize 10+ services into named, collapsible groups on the Services question so leads can scan without scrolling a wall of options. [Learn more →](/forms/lead-intake)

### Updates

- **Redesigned Form Theme Editor** — Simpler layout, plus **Copy from another form** and **Reset theme** for faster customization. Design now opens from the palette icon in the top-right of the form editor. [Learn more →](/forms/lead-intake#custom-themes)
- **Custom Themes for Lead Intake Forms** — Design a theme that matches your brand and website. Customize colors, fonts, and corners with live preview, and use a different theme per form. [Learn more →](/forms/lead-intake#custom-themes)
...
## Redesigned Form Theme Editor

The lead intake form theme editor got a fresh coat of paint, with a simpler layout and a couple of new ways to move fast.

- **Open from the palette button** — Design now opens from the palette icon in the top-right of the form editor (replacing the old left-rail toggle)
- **Copy from another form** — reuse a theme you've already built on another form via the new **Copy from** menu in the Design panel header
...
- Dropdown and color-picker surfaces are now lighter for better readability
...
Use the new form design tab to customize colors, font, and corners and see the changes live on your form. You can even have different themes for different forms and will get live feedback on color pairs for the best form readability.
...
Add notes directly to any lead. Create, edit, delete, and pin notes from the new **Notes** tab on the lead detail page. Pin important notes to keep them at the top, and use search to find what you need fast.

[Learn more about managing leads →](/leads/managing)
...
[Learn more about the quote page →](/leads/quote-view)
...
[Learn more about payment terms →](/leads/booking-flow)
...
## Saved Filters & Sorting on Leads Table

Your lead table filters and sort preferences are now automatically saved and restored when you return to the page. No more re-applying the same filters every time you navigate away.
...
[Learn about managing leads →](/leads/managing)
</Update>
...
## Enhancements to Leads Dashboard

We gave the lead table some love with faster data retrieval and more functionality!

**New Columns**
- Upcoming Bookings count - View future confirmed events
- Lead Created date
- Latest Quote date
- Lead Owner - the company member assigned to this lead
- Latest Communication - See the date of your last email with the lead

**Improved Functionality**
- All columns are sortable
- Lead owner filter (Plus/Pro plans)
- Sticky first column for easier scrolling on wide tables

The enhanced table gives you instant visibility into lead engagement and helps prioritize follow-up actions.

[Learn about managing leads →](/leads)
...
## Lead Owner Assignment <PlusBadge />

Assign leads to specific team members for better accountability and organization. Lead owners appear in the lead table and can be used as a filter to view your assigned leads.

**Key Features**
- Assign leads from the lead edit drawer
- See lead owner in lead header and table
- Filter leads by owner (Plus/Pro plans only)
- Internal support accounts automatically hidden from assignment lists

**Plan Availability**
- Plus: Assign leads to team members
- Pro: Assign leads to team members

Perfect for teams managing leads collaboratively or tracking individual team member performance.
...
[Learn about quote templates →](/templates/quote-templates) | [Configure your quote page →](/leads/quote-view)
...
[Learn about booking flow →](/leads/booking-flow)
...
Ready to boost your booking rates? Learn how to configure your quote template in our comprehensive [setup guide](/leads/quote-view).
