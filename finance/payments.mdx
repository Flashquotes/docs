...
Navigate to **Payments** from the main navigation to access your payment tracking dashboard. Payouts are available on the **Payouts** tab of the same page.
...
- [Sales Tax Reporting](https://app.flashquotes.com/reports/sales-tax)