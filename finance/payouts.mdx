...
Payouts live on the **Payouts** tab of the [Payments page](/finance/payments). The Payouts view shows when funds from customer payments will be deposited into your bank account. Stripe payouts transfer your available balance to your bank on a schedule you configure in your Stripe account settings.
