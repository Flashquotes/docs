...
4. Wait for sync to complete (button shows loading spinner); a toast confirms success or shows the QuickBooks error to act on
...
4. Wait for sync to complete; a toast confirms success or shows the QuickBooks error to act on
...
- **Sync failed with a QuickBooks error**: The toast shows the exact QuickBooks message. "Account Period Closed" means the books are closed for that period — fix it in QuickBooks and retry.
