...
<AccordionGroup>
  <Accordion icon="page" title="Page-by-Page Breakdown">
    ...
    <Note>
      You can hide pages like **Location** by setting a default event address. See **Hiding Pages** below.
    </Note>
  ...
  <Accordion icon="eye-slash" title="Hiding Pages">
    ...
    **Hide a page:**
    ...
    3. If the page contains the event address question, a dialog asks you to set a **default event address**. Pick your address from the Google suggestions. Free text isn't accepted because Flashquotes needs the exact location to calculate travel fees.
