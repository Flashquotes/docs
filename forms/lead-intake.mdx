...
<AccordionGroup>
  <Accordion icon="code" title="Form Embedding">
    ...
    <Info>
      Flashquotes forms are compatible with virtually all website platforms. See our [Platform Compatibility](/forms/compatibility) guide for details on embedding in specific platforms.
    </Info>
