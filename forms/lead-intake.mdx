...
The theme designer lets you match your lead intake form to your brand — no code required. Click **Design** tab in the form editor to set colors, fonts, and styling, with a live preview as you make changes.
