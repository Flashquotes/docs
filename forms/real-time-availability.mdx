...
<AccordionGroup >
  <Accordion icon="calendar-check" title="Visual Indicators" defaultOpen>
    When browsing dates on your form, customers will see:
    
    - **Green dots**: Dates when you're fully available
    - **Yellow dots**: Dates when you have limited or no availability
...
<AccordionGroup>
  <Accordion icon="calendar-xmark" title="Blocked Dates" defaultOpen>
    If you've marked a date as blocked, it will automatically show as unavailable (yellow).
