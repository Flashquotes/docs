...
<CardGroup cols={2}>
  <Card title="Export Quotes" icon="filter" href="/imports-exports/export-quotes">
    Export open, booked, and lost quotes with event types, sources, and addresses — one row per quote
  </Card>

  <Card title="Export Contacts" icon="user-group" href="/imports-exports/export-contacts">
