...
<Card title="Flashquotes AutoDraft" icon="magic-wand-sparkles" href="/contacts/autodraft">
...
<CardGroup cols={2}>
	<Card title="Pipeline & Contacts" icon="user-plus" href="/pipeline">
...
<AccordionGroup>
	<Accordion icon="paper-plane" title="Inquiry to Booking">
