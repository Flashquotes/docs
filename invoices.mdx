...
<Info>
  Navigate to **Reports → Sales Tax** to access comprehensive tax reports including sales tax collection, taxable vs non-taxable items, and tax jurisdiction summaries. Tax rate configuration still lives under **Settings → Tax Rates**.
</Info>
