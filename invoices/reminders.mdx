...
<Info>
  Reminders address the booking's current contact at the moment each one sends.
  If you [change the booking's contact](/bookings#changing-the-booking-contact),
  upcoming reminders go to the new contact automatically.
</Info>
