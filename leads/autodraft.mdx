...
Open [Services & items](https://app.flashquotes.com/services?tab=addons) and switch to the **Add-ons** tab to create extras you frequently offer (delivery, setup, additional hours). Set pricing for each.
