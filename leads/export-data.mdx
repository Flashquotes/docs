...
<Steps>
  ...
  <Step title="Download Your File">
    Your browser will automatically download a CSV file containing up to 1,000 leads with all their associated data.
  </Step>
</Steps>
...
<Note>
  Exports are limited to 1,000 leads at a time to ensure optimal performance. For larger exports, consider:
