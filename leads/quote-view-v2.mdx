...
Quote View V2 supports multi-day events through service days. Each service day can have its own date and time.
...
<Info>
  Service days are managed in the quote editor, not the V2 template editor. Each service day displays its specific date and time on the customer-facing quote page.
</Info>
