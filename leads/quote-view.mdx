...
Flashquotes now supports **multiple quote templates**, allowing you to create different designs for different event types, services, or branding variations. Each template can have its own gallery images, testimonials, add-ons, and other visual elements.

<Info>
  Learn how to create and manage quote templates in our [Quote Templates guide](/templates/quote-templates).
</Info>
