...
import { BetaBadge, PlusBadge } from "/snippets/badge.mdx";
...
### Inquiries found by Flashquotes AI <BetaBadge />
...
- **Contact name** and owner avatar (click the avatar to reassign) — hover the name for contact details; the name in the card links to the contact's page
...
- **Engagement icons** — email opens, quote views, and Book Now clicks; hover an icon to see exactly when it last happened, shown in your local time
...
- **Last viewed** — when the client last opened the quote
- **Source** — where the lead came from
- **Event type**
- **Location** — shown when your company has more than one
- **Owner** — shown when you can filter by owner

The date filters — **Quote date**, **Event date**, and **Last viewed** — are independent. Each names its own date in its pill, and you can apply any combination — for example, "Quote date: last 30 days" plus "Event date: next 3 months" to focus on recent quotes for upcoming events. Use **Last viewed** to surface quotes clients opened recently (time to follow up) or haven't opened in a while. It works on both the board and list views, and like every filter it carries into the CSV export.
