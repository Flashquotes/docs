...
<AccordionGroup>
  <Accordion icon="star" title="Create Add-Ons">
    In [Add-Ons Settings](https://app.flashquotes.com/services/addons), create add-on services that customers can add to their order.
...
<AccordionGroup>
    ...
    <Tip>
      Consider upgrading to [Quote View V2](/leads/quote-view-v2) for a modern, conversion-optimized quote template that can boost your booking rates.
    </Tip>
