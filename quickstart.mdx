...
<AccordionGroup>
  ...
  <Accordion icon="box" title="Add Resources">
    ...
    2. Name and categorize the resource, and pick a location if you have more than one.
    3. Click **Create**, then add a photo and description on the resource's details page.
...
<Accordion icon="user" title="Share or Embed Lead Intake Form">
...
<Accordion icon="square-check" title="Add Admin Task Templates">
    In [Task Settings](https://app.flashquotes.com/settings/tasks), you can set up your Admin Task Templates. These tasks will be added to the Overview section of each event and will be clearly presented in the [Events](https://app.flashquotes.com/events) section. You can also include a Default Due Date for each task, to ensure they’re completed timely.
  ...
  <Accordion icon="square-check" title="Add Event Brief Task Templates">
    In [Task Settings](https://app.flashquotes.com/settings/tasks), you can set up your Event Brief Task Templates. These tasks will be added to the Event brief section of each event and, most importantly, will be presented in the public event brief document to share with your event team.
...
<AccordionGroup>
	<Accordion icon="user" title="Create a Contact">

    1. Go to the [Contacts](https://app.flashquotes.com/contacts) page.
    2. Click on a contact or create one by clicking `New contact`.

    <img src="images/new-contact.png" alt="Create Contact" />
