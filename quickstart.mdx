...
<AccordionGroup>
  ...
  <Accordion icon="box" title="Add Resources">
    Resources like coffee carts, bar carts, vans, or trailers can be added on the [Resources tab of Services & items](https://app.flashquotes.com/services?tab=resources).
...
<AccordionGroup>
  <Accordion icon="file-invoice" title="Configure Booking Form">
    ...
    <Info>
      Payment terms are configured directly on quotes in the Booking Flow section. See our [Booking Flow guide](/leads/booking-flow).
    </Info>

  </Accordion>
<Accordion icon="user" title="Share or Embed Lead Intake Form">
    Share your lead intake form on social media or embed it on your website to receive quote requests from leads.
...
<AccordionGroup>
  <Accordion icon="star" title="Create Add-Ons">
    On the [Add-ons tab of Services & items](https://app.flashquotes.com/services?tab=addons), create add-on services that customers can add to their order.
...
<Info>
Save time with AutoDraft - automatically pre-build draft quotes from every lead. [Set up AutoDraft →](/autodraft)
</Info>
...
<AccordionGroup>
    ...
    <Tip>
      Learn how to [configure your quote template](/leads/quote-view) for a modern, conversion-optimized experience that can boost your booking rates.
    </Tip>
