...
Open **Services & items** from the sidebar. The page has tabs for each catalog:
- **Services** tab — manage your core offerings
- **Add-ons** tab — create extras and upsells (`/services?tab=addons`)
- **Resources** tab — track equipment and assets (`/services?tab=resources`)

<CardGroup cols={2}>
  <Card title="Structuring Services" icon="sitemap" href="/services/structuring-services">
