...
- **Short Description**: Appears under the service name on lead intake forms. Keep it under 75 characters.
- **Detailed Description**: Appears in the line items table on quotes and invoices. Supports rich text formatting and [shortcodes](/workflows/shortcodes/overview) like `{{quote.guest_count}}` or `{{lead.first_name}}`. Shortcodes resolve when the quote is created.
...
- **Short Description**: Lead intake forms, under the service name
- **Detailed Description**: The line items table on quotes and invoices. It's added automatically when the service is on a quote.

The Detailed Description doesn't appear on lead intake forms. There's also no shortcode to insert it (or the service name) elsewhere in a quote template.

Want a menu-style breakdown on the quote page itself? Add [Service Details lines](/templates/quote-templates#what-you-can-edit-on-templates) to your quote template.
...
<AccordionGroup>
  ...
  <Accordion icon="image" title="Service Presentation">
    ...
    - **Short Description**: Clear, benefit-focused text for lead intake forms
    - **Detailed Description**: Professional wording for quote and invoice line items. Supports rich text and [shortcodes](/workflows/shortcodes/overview) (e.g. `{{quote.guest_count}}`) that resolve when the quote is created
...
**Detailed Description not showing on your form**: Only the Short Description appears on lead intake forms. The Detailed Description shows on quote and invoice line items.
