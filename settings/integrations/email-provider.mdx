...
<Steps>
  ...
  <Step title="Add Gmail account">
    Click "Add account" under Google
  </Step>
  <Step title="Sign in">
...
<AccordionGroup>
  <Accordion icon="exclamation-triangle" title="Connection error status">
    Click Reconnect to refresh permissions
  </Accordion>
  <Accordion icon="eye-slash" title="Can't see email activity">
    Reconnect with expanded permissions enabled
  </Accordion>
  <Accordion icon="users" title="Multiple accounts needed">
    Connect additional Gmail accounts as needed for team members
  </Accordion>
</AccordionGroup>
...
- [Configure your Google integration settings](/settings/integrations/google)
