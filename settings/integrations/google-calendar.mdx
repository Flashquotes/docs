...
- If Google Calendar access fails, owners and admins receive an email with a reconnect link to Settings > Integrations
- Verify calendar sync is still configured for the location
- Reconnect your account to resume syncing
- After you reconnect, Flashquotes automatically re-syncs future booked events missed during the outage
