...
- When a contact replies to an email, active Quote Requested and Quote Sent workflows stop automatically
- Prevents automated emails from sending after contacts engage
- Only affects workflows started before the email response
- See [when workflows stop](/workflows/workflow-enrollments#automatically-stopping-workflows) for all auto-stop conditions
