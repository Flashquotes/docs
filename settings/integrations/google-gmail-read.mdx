...
- Click the email icon in the lead list view to initiate new emails
...
- When a lead replies to an email, active follow-up workflows stop automatically
- Prevents automated emails from sending after leads engage
...
Start email conversations directly from your lead details page.

1. Go to lead details page
2. Click the email icon in the lead header
...
4. **Use email icon for follow-ups** - Initiate emails from lead list for quick follow-ups
