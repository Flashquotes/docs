...
- If your Gmail connection fails, owners and admins receive an email with a reconnect link to Settings > Integrations. Click it, reconnect, and sync resumes.
- Flashquotes sends one email per outage; reconnecting re-arms the alert
