...
- If your connection fails, owners and admins receive an email explaining what broke, with a reconnect link to Settings > Integrations
- Flashquotes sends one email per outage; reconnecting re-arms the alert for future failures
...
- Flashquotes automatically re-syncs future calendar events missed while disconnected
