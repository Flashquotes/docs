...
All plans include a Flashquotes booking fee on each payment processed through Stripe.

### United States

By default, the booking fee is added on top of the invoice total and paid by your customer as a separate line item, resulting in no cost to you. US businesses can also choose to absorb the fee in **Settings → Company**, in which case the fee is deducted from your proceeds and is not visible to your customer.

### United Kingdom, Canada & Australia

International businesses are required to absorb the booking fee. The fee is deducted from your proceeds and is not displayed to your customer. Your quoted prices and booking totals are not affected.

The Flashquotes booking fee is a business-to-business charge between your company and Flashquotes for use of the platform.

<Note>
The booking fee is separate from [service charges](/settings/service-charges), which are business-defined fees you add to quotes (like gratuity or service fees).
</Note>

### Fees on Customer Refunds

When you issue a full refund to a customer, Stripe processing fees and Flashquotes booking fees are not refunded. These fees remain on the invoice and will show as a Flashquotes fee paid by you (the merchant), since the original customer payment that covered the fee has been refunded.
