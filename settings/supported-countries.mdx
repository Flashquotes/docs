...
Flashquotes is currently available for businesses in the **US (including Puerto Rico), UK, Canada, and Australia**. During signup, your country is detected from your business address. Non-US businesses must provide a valid tax identification number to connect to Stripe and accept payments.

## Supported Countries

| Country | Currency | Tax ID Required? |
|---------|----------|-----------------|
| United States (including Puerto Rico) | USD | No |
| United Kingdom | GBP | Yes — VAT Number |
| Canada | CAD | Yes — GST/HST Number |
| Australia | AUD | Yes — ABN |

Puerto Rico businesses sign up on the US path: your country is stored as United States with state set to `PR`, you settle in USD, and no separate tax ID is required. This matches Stripe, which treats Puerto Rico as part of the US market. Other US territories (US Virgin Islands, Guam, American Samoa, and the Northern Mariana Islands) are not supported.
...
If your business is located outside the supported countries, you will see a message during signup that Flashquotes is not yet available in your region.
