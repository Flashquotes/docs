...
Flashquotes charges a **2% platform fee** on payments processed through Flashquotes checkout. US businesses can choose to pass this fee to customers (default) or absorb it. UK, Canada, and Australia businesses are required to absorb it. See [Plans & Pricing → Platform Fee](/settings/plans#platform-fee) for details.
