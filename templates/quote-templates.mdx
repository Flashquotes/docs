...
Open **Templates** from the sidebar and select the **Quote Templates** tab to see all your quote templates. Each template card shows:
...
**From the Templates Page:**
1. Open **Templates** from the sidebar and select the **Quote Templates** tab
