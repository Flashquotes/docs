...
<AccordionGroup>
  ...
  <Accordion icon="list" title="Service Details">
    ...
    **Available Shortcodes:**
    ...
    <Note>
      There's no shortcode for a service's name or [Detailed Description](/services/core-services#where-each-description-appears). Both appear automatically in the line items table when the service is added to a quote. Use Service Details lines for menu-style content that applies to the whole quote.
    </Note>
  </Accordion>
