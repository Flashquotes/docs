...
<AccordionGroup>
  ...
  <Accordion title="The reviews step during onboarding seems stuck looking up my Google Business listing.">
    The Google Business lookup on the onboarding reviews step now has a timeout, so a slow or unresponsive lookup won't trap the step. The manual search box also stays visible the whole time.

    If the automatic lookup is taking too long or doesn't find your business, use the manual search box on the same screen to find your listing, or choose **Enter reviews manually** to move forward without connecting Google Business.
  </Accordion>
</AccordionGroup>
