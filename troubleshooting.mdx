...
<AccordionGroup>
  <Accordion title="Why are my clients not able to book me? They get an error message when they complete the booking form.">
    ...
    **Temporary Workaround:**
    ...
    1. Change your booking form to not require a deposit
    2. Modify the [payment schedule](/forms/payment-schedules) so payment isn't required to complete the booking form
