---
title: "Overview"
description: "Learn how to use Workflows in Flashquotes to enhance contact follow-up and engagement"
---
...
- **Automatic Stopping**: Workflows stop when a quote is booked. With the [full Gmail integration](/settings/integrations/google-gmail-read), a contact's email reply also stops follow-up workflows. See [when workflows stop](/workflows/workflow-enrollments#automatically-stopping-workflows)
