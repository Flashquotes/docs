...
4. Workflows continue until the contact books, replies to your email (with the [full Gmail integration](/settings/integrations/google-gmail-read)), or you stop them manually

<Note>
Quote Requested emails don't include a quote link, and there's no quote-link shortcode for this trigger. The quote may not exist yet when these emails send. To follow up with a quote link, use a Quote Sent workflow. Those emails include a **Review Quote** button automatically.
</Note>
...
**Key Features:**
- **Quote Link Included**: Every Quote Sent email automatically includes a **Review Quote** button that links to the quote. No shortcode needed
