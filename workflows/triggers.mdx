...
- Or set the default from **Settings → Quotes** in the Auto-Enroll in Workflow selector
...
- The default Quote Sent workflow is also the one used for [instant-quote auto-enrollment](/settings/quotes#auto-enroll-in-workflow)
