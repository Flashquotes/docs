...
- **No default Quote Sent workflow is set.** [Instant-quote auto-enrollment](/settings/quotes#auto-enroll-in-workflow) always uses the default Quote Sent workflow. If you have multiple Quote Sent workflows and none is marked as default, instant quotes won't enroll. Set a default from **Settings → Quotes** or from the workflow's detail page.
