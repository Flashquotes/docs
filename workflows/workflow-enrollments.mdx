...
## Enrolling Leads in Workflows <PlusBadge />
...
- **Quote Sent**: Enroll leads when sending quotes (toggle in send quote modal, then select a workflow)
- **Quote Booked**: Leads enroll automatically when a quote is booked
...
3. Enable the toggle to enroll the lead in a follow-up workflow
